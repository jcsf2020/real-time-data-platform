...
| BigQuery append scheduler proof | bigquery-append-scheduler-proof-evidence.md | Manual scheduler dispatch proved: 2 executions (`rfsmz`, `s6fdg`); BQ 6114→6117 (+3 exact); second run idempotent (6117 unchanged); SCHEDULERPROOFUSDT=3; duplicate_count=0; staging numRows=0; scheduler PAUSED before and after; Cloud SQL NEVER/STOPPED; PLAN_EXIT=0; 187 tests passed |
