...
| Normalize docs status wording | P2 | Some runbooks reference `status="success"`; application emits `status="ok"` — documentation should reflect the actual field value |
